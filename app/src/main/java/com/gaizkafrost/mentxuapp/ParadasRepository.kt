...
object ParadasRepository {
    ...
    private val paradas = mutableListOf(
        Parada(1, "Itsas-museoa", LatLng(43.330639, -3.030750)),
        Parada(2, "Itsas-portua", LatLng(43.330417, -3.030722)),
        Parada(3, "Agurtza itsasontzia", LatLng(43.327000, -3.023778)),
        Parada(4, "Santurtziko Udala (Mentxu)", LatLng(43.328833, -3.032944)),
        Parada(5, "“El niño y el perro” eskultura", LatLng(43.328833, -3.032306)),
